...
if args.env == "YChain":
	filename = "ptd"+"_env_"+str(args.env)+"_len_"+str(args.len)+"_lr_"+str(args.lr)+"_seed_"+str(args.seed)
...
errors = []
emp_state_error = []
progress = Progress(args.episodes, f"ptd env={args.env} seed={args.seed} lr={args.lr} len={args.len}")
