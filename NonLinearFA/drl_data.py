...
seed_errors = []
seed_progress = Progress(total_seeds, f"nonlinear data sweep env={args.env} trace={args.trace_type} lr={args.lr}", unit="seeds")
...
if args.log == 1 and args.save == 1:	
	if args.trace_type in ["etd", "etd_adaptive"]:
		filename = "drl_"+args.trace_type+"_int_"+str(args.intrst)+"_env_"+str(args.env)+"_size_"+str(args.n)+"_hidden_"+str(args.hidden)+"_lr_"+str(args.lr)+"_seeds_"+str(args.t_seeds)+"_epi_"+str(args.episodes)
	else:
		filename = "drl_"+args.trace_type+"_env_"+str(args.env)+"_size_"+str(args.n)+"_hidden_"+str(args.hidden)+"_lr_"+str(args.lr)+"_seeds_"+str(args.t_seeds)+"_epi_"+str(args.episodes)
