...
hunits = [1, 2, 4, 8, 16]
opt_comb = {"accumulating":{8:0.01, 12:0.001, 16:0.001}, "etd":{8:0.01, 12:0.01, 16:0.01},\
             "etd_adaptive":{8:0.001, 12:0.0005, 16:0.0005}, "gated":{8:0.01, 12:0.01, 16:0.01}}
...
pdf = matplotlib.backends.backend_pdf.PdfPages("plots/End2End_Grid2_hidden_units_test.pdf")
...
for t, size_lr in opt_comb.items():
    ...
    for size, lrate in size_lr.items():
        ...
        cnt += 1
plt.legend([name[t] for t, _ in opt_comb.items()], bbox_to_anchor=(0.5, 0., 0.1, 0.8), frameon=False, fontsize=16)
fig.tight_layout()
